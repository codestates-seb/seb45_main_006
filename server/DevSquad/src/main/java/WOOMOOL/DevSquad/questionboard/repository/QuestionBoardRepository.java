...
public interface QuestionBoardRepository extends JpaRepository<QuestionBoard, Long> {
    ...
    @Query("SELECT q FROM QuestionBoard q WHERE q.questionBoardStatus = 'QUESTIONBOARD_POSTED' AND q.memberProfile.memberProfileId = :memberProfileId AND SIZE(q.likesList) >= 10")
